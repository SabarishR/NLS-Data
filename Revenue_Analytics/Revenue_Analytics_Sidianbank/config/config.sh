## DEV MYSQL CONFIG
export DEV_MYSQL_DRIVER_NAME="mysql+mysqldb"
...
export DEV_MYSQL_DB="nlscore_sidian"

## CLOUD TESTING ENVIRONMENT MYSQL CONFIG
export CLOUDTESTING_MYSQL_DRIVER_NAME="mysql+mysqldb"
...
export CLOUDTESTING_MYSQL_DB="nlscore_sidian"
