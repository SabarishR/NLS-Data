...
"""
@app.route('/kollectCall_preferredSession_xgbClassifier_modelTraining',methods=['GET','POST'])
def train_model():
...
if __name__ == '__main__':
    ...
    app.run(host='0.0.0.0',port=2015, debug=False, threaded=True,use_reloader=False)
else :
