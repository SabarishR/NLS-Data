...
class common_config(object):
    ...
    VAR_CUSTOMER_RISK_STATUS = 'CUSTOMER_RISK_STATUS'
    ...
    VAR_XGB_CLASSIFIER_ONEHOT_LIST = ["RESIDENCE","GENDER","PROMISE_SUCCESS","REPAY_CURRENCY","STAGE"]
    ...
    VAR_OUTCOME_LIST = 'data/Stanbic_Outcomes.csv'
    VAR_CALL_PICKED = 'PICKED'
    VAR_OUTCOME = 'OUTCOME'
    VAR_CUSTOMER_RISK_STATUS_ACTUAL = ['D','W','F','I']
    VAR_CUSTOMER_RISK_STATUS_REPLACE = [51,52,53,54]
