...
def to_kollectCall_preferredSession_xgbClassifier_modelTraining():
    ...
    # label encoding
    df = CF.fn_labelEncode(df,app.config['VAR_CUSTOMER_RISK_STATUS_LABEL'])
...
def to_kollectCall_preferredSession_xgbClassifier_modelPredictions(data):
    ...
    userIPjson = {'ID':[data['ID']],'CUSTOMER_RISK_STATUS':[app.config['VAR_CUSTOMER_RISK_STATUS_LABEL']['CUSTOMER_RISK_STATUS'][data['CUSTOMER_RISK_STATUS']]],'INDUSTRY':[data['INDUSTRY']]}   
    #merge json
